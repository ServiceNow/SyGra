...
from core.graph.langgraph.langgraph_state import LangGraphState
...
class LangGraphFactory(BackendFactory):
    ...
    def get_message_content(self, msg: GraspMessage):
        """
        Convert langgraph message to plain text

        Args:
            msg: GraspMessage containing langgraph message
