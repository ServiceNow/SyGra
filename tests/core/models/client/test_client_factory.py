...
class TestClientFactory(unittest.TestCase):
    ...
    @patch(
        "grasp.core.models.client.client_factory.ClientFactory._create_openai_client"
    )
    ...
    @patch(
        "grasp.core.models.client.client_factory.ClientFactory._create_mistral_client"
    )
