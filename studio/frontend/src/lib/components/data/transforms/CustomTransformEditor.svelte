...
<div class="space-y-4">
		...
		<div>
			...
			{#if isEditing}
				<input
					...
					class="w-full px-3 py-2 text-sm font-mono border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-violet-500 focus:border-transparent"
				/>
	...
	{:else}
		<!-- Inline Code Mode -->
		<div class="flex items-start gap-2 p-3 bg-violet-50 dark:bg-violet-900/20 rounded-lg text-sm">
			<FileCode2 size={16} class="text-violet-500 flex-shrink-0 mt-0.5" />
			<div class="text-violet-700 dark:text-violet-300">
				<p class="font-medium">Inline Transform Code</p>
				<p class="text-xs mt-1 text-violet-600 dark:text-violet-400">
