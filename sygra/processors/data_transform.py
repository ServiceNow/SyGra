...
class AddRetryFieldsTransform(DataTransform):
    ...
    def transform(self, data: list[dict[str, Any]], params: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        return [self._add_retry_fields(record, max_retries, initial_retry_count) for record in data]

    def _add_retry_fields(self, record: dict[str, Any], max_retries: int, initial_retry_count: int) -> dict[str, Any]:
