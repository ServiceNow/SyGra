...
| `client_type`               | *(Optional)* `model_type` uses a client by default without this parameter. Use this to override default client for the selected model_type. Models only with backend as 'proxy' require the client_type to be defined as 'http'.                                                                                                                                                                                                                                                     |
