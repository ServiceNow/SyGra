# lib/grasp/exceptions/__init__.py
"""GraSP Library Exceptions"""

class GraSPError(Exception):
    """Base exception for GraSP library."""
    pass
...
__all__ = [
    "GraSPError", "ValidationError", "ExecutionError", "ConfigurationError",
    "NodeError", "DataError", "ModelError", "TimeoutError"
]