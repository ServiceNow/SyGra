...
from data_mapper.pipelines import PipelineFactory
from logger.logger_config import logger
from validators.custom_schemas import CoreLLMDataFabricFormat, MetaInfo, PipelineStep
from data_mapper.helper import PipelineConfig
from core.graph.graph_config import GraphConfig
from data_mapper.helper import transform_registry
...
class DataMapper:
    ...
    def build_rows_and_validate(context: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        generated_by = context.get("generated_by", "grasp")
