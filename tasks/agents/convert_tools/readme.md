Once you have the static web agent eval data from huggingface, follow these steps:
...
Once you complete the above steps, the "chat_history_seed.json" file will be created inside the tasks/agents/web_agents_eval folder which 
will be used to run the static web agent eval flow.
